...
void cambio(char c1[]);//para que el string no tenga un salto de linea de más
...
int main(){
	...
	system("cls");
	printf("Jugador 1 Introduce tu nombre: \n");
	//fflush(stdin);//esto limpia el buffer de la entrada
	fgets(id_player1,20,stdin);
	cambio(id_player1);

	tab_pos();//|1|2|3...

	printf("\nTablero %s: ",id_player1);
	impr_tab(tablero1);
//------------------------------------------------------------------------------
...
//---------------------------Player 2 ahora-------------------------------------
	...
	system("cls");
	printf("+---------------------------------------------+\n");
	printf("|     Ahora viene el turno del Jugador 2:     |\n");
	printf("+---------------------------------------------+\n");
	system("pause");
	system("cls");
	printf("Jugador 2 Introduce tu nommbre: \n");
	fflush(stdin);//esto limpia el buffer de la entrada
	fgets(id_player2,20,stdin);
	cambio(id_player1);
...
void impr_tab(char tableros[][10]){//imprime los tableros de ambos
	...
	for(i=0;i<10;i++){
		for(j=0;j<10;j++){
			...
			/*else if(tableros[i][j]=='O' || tableros[i][j]=='X'){
				printf("|  %c|",tableros[i][j]);
			}*/
